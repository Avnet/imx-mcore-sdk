...
/*! @name Driver version */
/*@{*/
/*! @brief RTD_CMC driver version 2.0.1. */
#define FSL_RTD_CMC_DRIVER_VERSION (MAKE_VERSION(2, 0, 1))
/* @} */
...
{
    return ((base->CKSTAT & CMC_CKSTAT_WAKEUP_MASK) >> CMC_CKSTAT_WAKEUP_SHIFT);
}
