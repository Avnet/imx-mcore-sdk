...
/*! @name Driver version */
/*@{*/
/*! @brief upower driver version 2.0.0. */
#define FSL_UPOWER_DRIVER_VERSION (MAKE_VERSION(2, 0, 2))
/*@}*/
...
typedef enum _upower_ps_mask
{
    ...
    kUPOWER_PS_DDRC      = (1U << 9U),  /*!< LPAV: DDR controller */
    kUPOWER_PS_PXP_EPDC  = (1U << 10U), /*!< LPAV: PXP, EPDC */
    kUPOWER_PS_MIPI_DSI  = (1U << 11U), /*!< LPAV: MIPI DSI */
    kUPOWER_PS_MIPI_CSI  = (1U << 12U), /*!< LPAV: MIPI CSI */
    kUPOWER_PS_AV_NIC    = (1U << 13U), /*!< LPAV: NIC, System RAM2, DCNano */
    kUPOWER_PS_FUSION_AO = (1U << 14U), /*!< RTD: Fusion "Always ON" */
    kUPOWER_PS_FUSES     = (1U << 15U), /*!< RTD: Fuses */
} upower_ps_mask_t;
