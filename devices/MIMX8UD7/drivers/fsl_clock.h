...
typedef enum _clock_ip_name
{
    kCLOCK_IpInvalid = 0U,
    /* PCC 0 for CM33 */
    kCLOCK_Dma0           = (uint32_t)&PCC0->PCC_DMA0_MP,
    kCLOCK_Dma0Ch0        = (uint32_t)&PCC0->PCC_DMA0_CH0,
    kCLOCK_Dma0Ch1        = (uint32_t)&PCC0->PCC_DMA0_CH1,
    kCLOCK_Dma0Ch2        = (uint32_t)&PCC0->PCC_DMA0_CH2,
    kCLOCK_Dma0Ch3        = (uint32_t)&PCC0->PCC_DMA0_CH3,
    kCLOCK_Dma0Ch4        = (uint32_t)&PCC0->PCC_DMA0_CH4,
    kCLOCK_Dma0Ch5        = (uint32_t)&PCC0->PCC_DMA0_CH5,
    kCLOCK_Dma0Ch6        = (uint32_t)&PCC0->PCC_DMA0_CH6,
    kCLOCK_Dma0Ch7        = (uint32_t)&PCC0->PCC_DMA0_CH7,
    kCLOCK_Dma0Ch8        = (uint32_t)&PCC0->PCC_DMA0_CH8,
    kCLOCK_Dma0Ch9        = (uint32_t)&PCC0->PCC_DMA0_CH9,
    kCLOCK_Dma0Ch10       = (uint32_t)&PCC0->PCC_DMA0_CH10,
    kCLOCK_Dma0Ch11       = (uint32_t)&PCC0->PCC_DMA0_CH11,
    kCLOCK_Dma0Ch12       = (uint32_t)&PCC0->PCC_DMA0_CH12,
    kCLOCK_Dma0Ch13       = (uint32_t)&PCC0->PCC_DMA0_CH13,
    kCLOCK_Dma0Ch14       = (uint32_t)&PCC0->PCC_DMA0_CH14,
    kCLOCK_Dma0Ch15       = (uint32_t)&PCC0->PCC_DMA0_CH15,
    kCLOCK_Dma0Ch16       = (uint32_t)&PCC0->PCC_DMA0_CH16,
    kCLOCK_Dma0Ch17       = (uint32_t)&PCC0->PCC_DMA0_CH17,
    kCLOCK_Dma0Ch18       = (uint32_t)&PCC0->PCC_DMA0_CH18,
    kCLOCK_Dma0Ch19       = (uint32_t)&PCC0->PCC_DMA0_CH19,
    kCLOCK_Dma0Ch20       = (uint32_t)&PCC0->PCC_DMA0_CH20,
    kCLOCK_Dma0Ch21       = (uint32_t)&PCC0->PCC_DMA0_CH21,
    kCLOCK_Dma0Ch22       = (uint32_t)&PCC0->PCC_DMA0_CH22,
    kCLOCK_Dma0Ch23       = (uint32_t)&PCC0->PCC_DMA0_CH23,
    kCLOCK_Dma0Ch24       = (uint32_t)&PCC0->PCC_DMA0_CH24,
    kCLOCK_Dma0Ch25       = (uint32_t)&PCC0->PCC_DMA0_CH25,
    kCLOCK_Dma0Ch26       = (uint32_t)&PCC0->PCC_DMA0_CH26,
    kCLOCK_Dma0Ch27       = (uint32_t)&PCC0->PCC_DMA0_CH27,
    kCLOCK_Dma0Ch28       = (uint32_t)&PCC0->PCC_DMA0_CH28,
    kCLOCK_Dma0Ch29       = (uint32_t)&PCC0->PCC_DMA0_CH29,
    kCLOCK_Dma0Ch30       = (uint32_t)&PCC0->PCC_DMA0_CH30,
    kCLOCK_Dma0Ch31       = (uint32_t)&PCC0->PCC_DMA0_CH31,
    kCLOCK_Mu0A           = (uint32_t)&PCC0->PCC_MU0_A,
    kCLOCK_Mu1A           = (uint32_t)&PCC0->PCC_MU1_A,
    kCLOCK_Mu2A           = (uint32_t)&PCC0->PCC_MU2_A,
    kCLOCK_Syspm0         = (uint32_t)&PCC0->PCC_SYSPM0,
    kCLOCK_Wuu0           = (uint32_t)&PCC0->PCC_WUU0,
    kCLOCK_UpowerMuARtd   = (uint32_t)&PCC0->PCC_UPOWER_MUA_RTD,
    kCLOCK_Wdog0          = (uint32_t)&PCC0->PCC_WDOG0 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Wdog1          = (uint32_t)&PCC0->PCC_WDOG1 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_TrdcMgr        = (uint32_t)&PCC0->PCC_TRDC_MGR,
    kCLOCK_TrdcMbc0       = (uint32_t)&PCC0->PCC_TRDC_MBC0,
    kCLOCK_TrdcMbc1       = (uint32_t)&PCC0->PCC_TRDC_MBC1,
    kCLOCK_TrdcMbc2       = (uint32_t)&PCC0->PCC_TRDC_MBC2,
    kCLOCK_TrdcMbc3       = (uint32_t)&PCC0->PCC_TRDC_MBC3,
    kCLOCK_TrdcMrc        = (uint32_t)&PCC0->PCC_TRDC_MRC,
    kCLOCK_Sema420        = (uint32_t)&PCC0->PCC_SEMA42_0,
    kCLOCK_Bbnsm          = (uint32_t)&PCC0->PCC_BBNSM,
    kCLOCK_Flexspi0       = (uint32_t)&PCC0->PCC_FLEXSPI0 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpit0          = (uint32_t)&PCC0->PCC_LPIT0 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Flexio0        = (uint32_t)&PCC0->PCC_FLEXIO0 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_I3c0           = (uint32_t)&PCC0->PCC_I3C0 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpspi0         = (uint32_t)&PCC0->PCC_LPSPI0 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpspi1         = (uint32_t)&PCC0->PCC_LPSPI1 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Adc0           = (uint32_t)&PCC0->PCC_ADC0 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Cmp0           = (uint32_t)&PCC0->PCC_CMP0,
    kCLOCK_Cmp1           = (uint32_t)&PCC0->PCC_CMP1,
    kCLOCK_Dac0           = (uint32_t)&PCC0->PCC_DAC0 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Dac1           = (uint32_t)&PCC0->PCC_DAC1 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Cm33Cache      = (uint32_t)&PCC0->PCC_CM33_CACHE_CONTROLLER,
    kCLOCK_SentinelLpuart = (uint32_t)&PCC0->PCC_SENTINEL_LPUART | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_PowersysWdog   = (uint32_t)&PCC0->PCC_POWERSYS_WDOG | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Ocotp          = (uint32_t)&PCC0->PCC_OCOTP,

    /* PCC 1 for CM33 */
    kCLOCK_Tpiu     = (uint32_t)&PCC1->PCC_TPIU | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Swo      = (uint32_t)&PCC1->PCC_SWO | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Flexspi1 = (uint32_t)&PCC1->PCC_FLEXSPI1 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lptmr0   = (uint32_t)&PCC1->PCC_LPTMR0,
    kCLOCK_Lptmr1   = (uint32_t)&PCC1->PCC_LPTMR1,
    kCLOCK_Tpm0     = (uint32_t)&PCC1->PCC_TPM0 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Tpm1     = (uint32_t)&PCC1->PCC_TPM1 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpi2c0   = (uint32_t)&PCC1->PCC_LPI2C0 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpi2c1   = (uint32_t)&PCC1->PCC_LPI2C1 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpuart0  = (uint32_t)&PCC1->PCC_LPUART0 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpuart1  = (uint32_t)&PCC1->PCC_LPUART1 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Sai0     = (uint32_t)&PCC1->PCC_SAI0,
    kCLOCK_Sai1     = (uint32_t)&PCC1->PCC_SAI1,
    kCLOCK_DigFiltA = (uint32_t)&PCC1->PCC_DIGITAL_FILTER_A,
    kCLOCK_DigFiltB = (uint32_t)&PCC1->PCC_DIGITAL_FILTER_B,
    kCLOCK_Adc1     = (uint32_t)&PCC1->PCC_ADC1 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Flexcan  = (uint32_t)&PCC1->PCC_FLEXCAN | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_RgpioA   = (uint32_t)&PCC1->PCC_RGPIOA,
    kCLOCK_RgpioB   = (uint32_t)&PCC1->PCC_RGPIOB,
    kCLOCK_RgpioC   = (uint32_t)&PCC1->PCC_RGPIOC,

    /* PCC 2 for FusionF1 */
    kCLOCK_Mu1B    = (uint32_t)&PCC2->PCC_MU1_B,
    kCLOCK_Wdog2   = (uint32_t)&PCC2->PCC_WDOG2 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Tpm2    = (uint32_t)&PCC2->PCC_TPM2 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Tpm3    = (uint32_t)&PCC2->PCC_TPM3 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Mrt     = (uint32_t)&PCC2->PCC_MRT,
    kCLOCK_Lpi2c2  = (uint32_t)&PCC2->PCC_LPI2C2 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpi2c3  = (uint32_t)&PCC2->PCC_LPI2C3 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_I3c1    = (uint32_t)&PCC2->PCC_I3C1 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpuart2 = (uint32_t)&PCC2->PCC_LPUART2 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpuart3 = (uint32_t)&PCC2->PCC_LPUART3 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpspi2  = (uint32_t)&PCC2->PCC_LPSPI2 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpspi3  = (uint32_t)&PCC2->PCC_LPSPI3 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Sai2    = (uint32_t)&PCC2->PCC_SAI2,
    kCLOCK_Sai3    = (uint32_t)&PCC2->PCC_SAI3,
    kCLOCK_Micfil  = (uint32_t)&PCC2->PCC_MICFIL,

    /* PCC 3 for CA35 */
    kCLOCK_Dma1         = (uint32_t)&PCC3->PCC_DMA1_MP,
    kCLOCK_Dma1Ch0      = (uint32_t)&PCC3->PCC_DMA1_CH0,
    kCLOCK_Dma1Ch1      = (uint32_t)&PCC3->PCC_DMA1_CH1,
    kCLOCK_Dma1Ch2      = (uint32_t)&PCC3->PCC_DMA1_CH2,
    kCLOCK_Dma1Ch3      = (uint32_t)&PCC3->PCC_DMA1_CH3,
    kCLOCK_Dma1Ch4      = (uint32_t)&PCC3->PCC_DMA1_CH4,
    kCLOCK_Dma1Ch5      = (uint32_t)&PCC3->PCC_DMA1_CH5,
    kCLOCK_Dma1Ch6      = (uint32_t)&PCC3->PCC_DMA1_CH6,
    kCLOCK_Dma1Ch7      = (uint32_t)&PCC3->PCC_DMA1_CH7,
    kCLOCK_Dma1Ch8      = (uint32_t)&PCC3->PCC_DMA1_CH8,
    kCLOCK_Dma1Ch9      = (uint32_t)&PCC3->PCC_DMA1_CH9,
    kCLOCK_Dma1Ch10     = (uint32_t)&PCC3->PCC_DMA1_CH10,
    kCLOCK_Dma1Ch11     = (uint32_t)&PCC3->PCC_DMA1_CH11,
    kCLOCK_Dma1Ch12     = (uint32_t)&PCC3->PCC_DMA1_CH12,
    kCLOCK_Dma1Ch13     = (uint32_t)&PCC3->PCC_DMA1_CH13,
    kCLOCK_Dma1Ch14     = (uint32_t)&PCC3->PCC_DMA1_CH14,
    kCLOCK_Dma1Ch15     = (uint32_t)&PCC3->PCC_DMA1_CH15,
    kCLOCK_Dma1Ch16     = (uint32_t)&PCC3->PCC_DMA1_CH16,
    kCLOCK_Dma1Ch17     = (uint32_t)&PCC3->PCC_DMA1_CH17,
    kCLOCK_Dma1Ch18     = (uint32_t)&PCC3->PCC_DMA1_CH18,
    kCLOCK_Dma1Ch19     = (uint32_t)&PCC3->PCC_DMA1_CH19,
    kCLOCK_Dma1Ch20     = (uint32_t)&PCC3->PCC_DMA1_CH20,
    kCLOCK_Dma1Ch21     = (uint32_t)&PCC3->PCC_DMA1_CH21,
    kCLOCK_Dma1Ch22     = (uint32_t)&PCC3->PCC_DMA1_CH22,
    kCLOCK_Dma1Ch23     = (uint32_t)&PCC3->PCC_DMA1_CH23,
    kCLOCK_Dma1Ch24     = (uint32_t)&PCC3->PCC_DMA1_CH24,
    kCLOCK_Dma1Ch25     = (uint32_t)&PCC3->PCC_DMA1_CH25,
    kCLOCK_Dma1Ch26     = (uint32_t)&PCC3->PCC_DMA1_CH26,
    kCLOCK_Dma1Ch27     = (uint32_t)&PCC3->PCC_DMA1_CH27,
    kCLOCK_Dma1Ch28     = (uint32_t)&PCC3->PCC_DMA1_CH28,
    kCLOCK_Dma1Ch29     = (uint32_t)&PCC3->PCC_DMA1_CH29,
    kCLOCK_Dma1Ch30     = (uint32_t)&PCC3->PCC_DMA1_CH30,
    kCLOCK_Dma1Ch31     = (uint32_t)&PCC3->PCC_DMA1_CH31,
    kCLOCK_Mu0B         = (uint32_t)&PCC3->PCC_MU0_B,
    kCLOCK_Mu3A         = (uint32_t)&PCC3->PCC_MU3_A,
    kCLOCK_Wuu1         = (uint32_t)&PCC3->PCC_WUU1,
    kCLOCK_Syspm1       = (uint32_t)&PCC3->PCC_SYSPM1,
    kCLOCK_UpowerMuAApd = (uint32_t)&PCC3->PCC_UPOWER_MUA_APD,
    kCLOCK_Wdog3        = (uint32_t)&PCC3->PCC_WDOG3 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Wdog4        = (uint32_t)&PCC3->PCC_WDOG4 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Caam         = (uint32_t)&PCC3->PCC_CAAM,
    kCLOCK_XrdcMgr      = (uint32_t)&PCC3->PCC_XRDC_MGR,
    kCLOCK_Sema421      = (uint32_t)&PCC3->PCC_SEMA42_1,
    kCLOCK_Lpit1        = (uint32_t)&PCC3->PCC_LPIT1 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Tpm4         = (uint32_t)&PCC3->PCC_TPM4 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Tpm5         = (uint32_t)&PCC3->PCC_TPM5 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Flexio1      = (uint32_t)&PCC3->PCC_FLEXIO1 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_I3c2         = (uint32_t)&PCC3->PCC_I3C2 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpi2c4       = (uint32_t)&PCC3->PCC_LPI2C4 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpi2c5       = (uint32_t)&PCC3->PCC_LPI2C5 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpuart4      = (uint32_t)&PCC3->PCC_LPUART4 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpuart5      = (uint32_t)&PCC3->PCC_LPUART5 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpspi4       = (uint32_t)&PCC3->PCC_LPSPI4 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpspi5       = (uint32_t)&PCC3->PCC_LPSPI5 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,

    /* PCC 4 for CA35 */
    kCLOCK_Flexspi2 = (uint32_t)&PCC4->PCC_FLEXSPI2 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Tpm6     = (uint32_t)&PCC4->PCC_TPM6 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Tpm7     = (uint32_t)&PCC4->PCC_TPM7 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpi2c6   = (uint32_t)&PCC4->PCC_LPI2C6 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpi2c7   = (uint32_t)&PCC4->PCC_LPI2C7 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpuart6  = (uint32_t)&PCC4->PCC_LPUART6 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpuart7  = (uint32_t)&PCC4->PCC_LPUART7 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Sai4     = (uint32_t)&PCC4->PCC_SAI4,
    kCLOCK_Sai5     = (uint32_t)&PCC4->PCC_SAI5,
    kCLOCK_DigFiltE = (uint32_t)&PCC4->PCC_DIGITAL_FILTER_E,
    kCLOCK_DigFiltF = (uint32_t)&PCC4->PCC_DIGITAL_FILTER_F,
    kCLOCK_Usdhc0   = (uint32_t)&PCC4->PCC_USDHC0 | PCC_PCS_AVAIL_MASK,
    kCLOCK_Usdhc1   = (uint32_t)&PCC4->PCC_USDHC1 | PCC_PCS_AVAIL_MASK,
    kCLOCK_Usdhc2   = (uint32_t)&PCC4->PCC_USDHC2 | PCC_PCS_AVAIL_MASK,
    kCLOCK_Usb0     = (uint32_t)&PCC4->PCC_USB0,
    kCLOCK_Usb0Phy  = (uint32_t)&PCC4->PCC_USB0_PHY,
    kCLOCK_Usb1     = (uint32_t)&PCC4->PCC_USB1,
    kCLOCK_Usb1Phy  = (uint32_t)&PCC4->PCC_USB1_PHY,
    kCLOCK_UsbXbar  = (uint32_t)&PCC4->PCC_USB_XBAR,
    kCLOCK_Enet     = (uint32_t)&PCC4->PCC_ENET,
    kCLOCK_RgpioE   = (uint32_t)&PCC4->PCC_RGPIOE,
    kCLOCK_RgpioF   = (uint32_t)&PCC4->PCC_RGPIOF,

    /* PCC 5 for HiFi4 */
    kCLOCK_Dma2      = (uint32_t)&PCC5->PCC_DMA2_MP,
    kCLOCK_Dma2Ch0   = (uint32_t)&PCC5->PCC_DMA2_CH0,
    kCLOCK_Dma2Ch1   = (uint32_t)&PCC5->PCC_DMA2_CH1,
    kCLOCK_Dma2Ch2   = (uint32_t)&PCC5->PCC_DMA2_CH2,
    kCLOCK_Dma2Ch3   = (uint32_t)&PCC5->PCC_DMA2_CH3,
    kCLOCK_Dma2Ch4   = (uint32_t)&PCC5->PCC_DMA2_CH4,
    kCLOCK_Dma2Ch5   = (uint32_t)&PCC5->PCC_DMA2_CH5,
    kCLOCK_Dma2Ch6   = (uint32_t)&PCC5->PCC_DMA2_CH6,
    kCLOCK_Dma2Ch7   = (uint32_t)&PCC5->PCC_DMA2_CH7,
    kCLOCK_Dma2Ch8   = (uint32_t)&PCC5->PCC_DMA2_CH8,
    kCLOCK_Dma2Ch9   = (uint32_t)&PCC5->PCC_DMA2_CH9,
    kCLOCK_Dma2Ch10  = (uint32_t)&PCC5->PCC_DMA2_CH10,
    kCLOCK_Dma2Ch11  = (uint32_t)&PCC5->PCC_DMA2_CH11,
    kCLOCK_Dma2Ch12  = (uint32_t)&PCC5->PCC_DMA2_CH12,
    kCLOCK_Dma2Ch13  = (uint32_t)&PCC5->PCC_DMA2_CH13,
    kCLOCK_Dma2Ch14  = (uint32_t)&PCC5->PCC_DMA2_CH14,
    kCLOCK_Dma2Ch15  = (uint32_t)&PCC5->PCC_DMA2_CH15,
    kCLOCK_Dma2Ch16  = (uint32_t)&PCC5->PCC_DMA2_CH16,
    kCLOCK_Dma2Ch17  = (uint32_t)&PCC5->PCC_DMA2_CH17,
    kCLOCK_Dma2Ch18  = (uint32_t)&PCC5->PCC_DMA2_CH18,
    kCLOCK_Dma2Ch19  = (uint32_t)&PCC5->PCC_DMA2_CH19,
    kCLOCK_Dma2Ch20  = (uint32_t)&PCC5->PCC_DMA2_CH20,
    kCLOCK_Dma2Ch21  = (uint32_t)&PCC5->PCC_DMA2_CH21,
    kCLOCK_Dma2Ch22  = (uint32_t)&PCC5->PCC_DMA2_CH22,
    kCLOCK_Dma2Ch23  = (uint32_t)&PCC5->PCC_DMA2_CH23,
    kCLOCK_Dma2Ch24  = (uint32_t)&PCC5->PCC_DMA2_CH24,
    kCLOCK_Dma2Ch25  = (uint32_t)&PCC5->PCC_DMA2_CH25,
    kCLOCK_Dma2Ch26  = (uint32_t)&PCC5->PCC_DMA2_CH26,
    kCLOCK_Dma2Ch27  = (uint32_t)&PCC5->PCC_DMA2_CH27,
    kCLOCK_Dma2Ch28  = (uint32_t)&PCC5->PCC_DMA2_CH28,
    kCLOCK_Dma2Ch29  = (uint32_t)&PCC5->PCC_DMA2_CH29,
    kCLOCK_Dma2Ch30  = (uint32_t)&PCC5->PCC_DMA2_CH30,
    kCLOCK_Dma2Ch31  = (uint32_t)&PCC5->PCC_DMA2_CH31,
    kCLOCK_Mu2B      = (uint32_t)&PCC5->PCC_MU2_B,
    kCLOCK_Mu3B      = (uint32_t)&PCC5->PCC_MU3_B,
    kCLOCK_Sema422   = (uint32_t)&PCC5->PCC_SEMA42_2,
    kCLOCK_Tpm8      = (uint32_t)&PCC5->PCC_TPM8 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Sai6      = (uint32_t)&PCC5->PCC_SAI6,
    kCLOCK_Sai7      = (uint32_t)&PCC5->PCC_SAI7,
    kCLOCK_Spdif     = (uint32_t)&PCC5->PCC_SPDIF,
    kCLOCK_Isi       = (uint32_t)&PCC5->PCC_ISI,
    kCLOCK_CsiRegs   = (uint32_t)&PCC5->PCC_CSI_REGS,
    kCLOCK_Csi       = (uint32_t)&PCC5->PCC_CSI | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Dsi       = (uint32_t)&PCC5->PCC_DSI | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Wdog5     = (uint32_t)&PCC5->PCC_WDOG5 | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Epdc      = (uint32_t)&PCC5->PCC_EPDC | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Pxp       = (uint32_t)&PCC5->PCC_PXP,
    kCLOCK_Gpu2d     = (uint32_t)&PCC5->PCC_GPU2D | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Gpu3d     = (uint32_t)&PCC5->PCC_GPU3D | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Dcnano    = (uint32_t)&PCC5->PCC_DC_NANO | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_Lpddr4    = (uint32_t)&PCC5->PCC_LPDDR4,
    kCLOCK_CsiClkUi  = (uint32_t)&PCC5->PCC_CSI_CLK_UI | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_CsiClkEsc = (uint32_t)&PCC5->PCC_CSI_CLK_ESC | PCC_PCS_AVAIL_MASK | PCC_PCD_FRAC_AVAIL_MASK,
    kCLOCK_RgpioD    = (uint32_t)&PCC5->PCC_RGPIOD,

    /* Non-PCC IPs */
    kCLOCK_Mqs0 = (uint32_t)&CGC_RTD->MQS0CLK | IP_NAME_NON_PCC_FLAG_MASK,
    kCLOCK_Mqs1 = (uint32_t)&CGC_AD->MQS1CLK | IP_NAME_NON_PCC_FLAG_MASK,
} clock_ip_name_t;
...
{
    kCGC_SysOscModeExt         = 0U,                                                      /*!< Use external clock. */
    kCGC_SysOscModeOscLowPower = CGC_SOSCCFG_SYSOSC_BYPASS_EN_MASK,                       /*!< Oscillator low power. */
    kCGC_SysOscModeOscHighGain = CGC_SOSCCFG_SYSOSC_BYPASS_EN_MASK | CGC_SOSCCFG_HGO_MASK /*!< Oscillator high gain. */
} cgc_sosc_mode_t;
