...
#ifndef GENERIC_LIST_DEPENDENCY_FSL_COMMON
#define GENERIC_LIST_DEPENDENCY_FSL_COMMON (1U)
#endif
#if (defined(GENERIC_LIST_DEPENDENCY_FSL_COMMON) && (GENERIC_LIST_DEPENDENCY_FSL_COMMON > 0U))
