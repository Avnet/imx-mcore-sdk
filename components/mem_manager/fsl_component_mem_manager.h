...
#ifndef MEM_MANAGER_DEPENDENCY_FSL_COMMON
#define MEM_MANAGER_DEPENDENCY_FSL_COMMON (1U)
#endif
#if (defined(MEM_MANAGER_DEPENDENCY_FSL_COMMON) && (MEM_MANAGER_DEPENDENCY_FSL_COMMON > 0U))
