...
int main(void)
{
    ...
    SIM_AD->DGO_GP3 = SIM_AD_DGO_GP3_RESET1_B_CONFIG_DFD(0x3f) | 
        SIM_AD_DGO_GP3_RESET1_B_CONFIG_DFCS(1) |
        SIM_AD_DGO_GP3_RESET1_B_CONFIG_DFE(1) |
        SIM_AD_DGO_GP3_RESET1_B_CONFIG_ODE(1) |
        SIM_AD_DGO_GP3_RESET1_B_CONFIG_PFE(1) |
        SIM_AD_DGO_GP3_RESET1_B_CONFIG_PE(1) |
