 ...
 */
#define APP_MU0_MUB_F0_INIT_SRTM_COMMUNICATION_FLG (0x1UL)
/* 1 ms */
#define APP_WAIT_MU0_MUB_F0_FLG_FROM_UBOOT_TICK MAX((1 / portTICK_PERIOD_MS), 1)
...
#define APP_HANDSHAKE_WITH_UBOOT_TIMEOUT_MS (10000U)
