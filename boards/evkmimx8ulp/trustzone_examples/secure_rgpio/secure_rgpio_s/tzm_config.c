        ...
        for (j = 0U; j < hwConfig.domainNumber; j++)
        {
            ...
            for (m = 0U; m < 4; m++)
            {
                ...
                for (n = 0U; n < mbcHwConfig.blockNum; n++)
                {
                    ...
                    if(i == 0 && j == 0 && m == 1){ /*mbc0 tcmu blocknum[4-7] for non-secure data2*/
                        if(n > 3 && n < 8){
                            mbcBlockConfig.nseEnable = true;
                        }else{
                            mbcBlockConfig.nseEnable = false;
                        }
                    }else if(i == 0 && j == 0 && m == 0){ /*mbc0 tcml blocknum[4-7] for non-secure data*/
                        if( n >=4 && n < 8 ){
                            mbcBlockConfig.nseEnable = true;
                        }else{
                            mbcBlockConfig.nseEnable = false;
                        }
                    }else if(i == 0 && j == 0 && m == 3){ /*mbc0 gpioa and gpiob for non-secure*/
                        if(n == 0 || n == 1){
                            mbcBlockConfig.nseEnable = true;
                        }else{
                            mbcBlockConfig.nseEnable = false;
